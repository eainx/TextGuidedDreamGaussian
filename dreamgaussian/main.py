...
from CLIP_SAM.clipsam import Sam
from segment_anything import SamAutomaticMaskGenerator, build_sam, sam_model_registry, SamPredictor
class GUI:
    def __init__(self, opt):
        ...
        self.sam_base = sam_model_registry[self.model_type](
            checkpoint="/home/eainx/Documents/DL/FinalProject/dreamgaussian/CLIP_SAM/sam_vit_h_4b8939.pth")
    ...
    def train_step(self):
        ...
        for _ in range(self.train_steps):
            ...
            for _ in range(self.opt.batch_size):
                ...
                image = out["image"].unsqueeze(0)  # [1, 3, H, W] in [0, 1]
                images.append(image)
                # cv2.imshow("image", image.squeeze(0)[[2, 1, 0], :, :].permute(1, 2, 0).detach().cpu().numpy())
                # cv2.waitKey(1)
    ...
    def load_input(self, file):
        ...
        clipseg_sam = Sam(self.sam, text=self.opt.text)
        img = clipseg_sam.mask_image(file, self.W, self.H)
